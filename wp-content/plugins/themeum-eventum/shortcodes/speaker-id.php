...
//shortocde
add_shortcode( 'themeum_speaker_page_listing_by_id', function($atts, $content = null){
...
if (class_exists('WPBakeryVisualComposerAbstract')) {
  vc_map(array(
    "name" => esc_html__("Speaker Listing By ID", "themeum-eventum"),
    "base" => "themeum_speaker_page_listing_by_id",
    ...
    array(
        "type" => "textfield",
        "heading" => esc_html__("Put Here ID", "themeum-eventum"),
        "param_name" => "id_list",
        "description" => esc_html__("Put Here Speaker ID separate by comma eg: 12,23,36", "themeum-eventum"),
        "value" => "",
    ),             
