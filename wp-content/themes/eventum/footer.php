...
<?php 
$user = '';
if ( $themeum_options['preloader_color'] ) {
   $user = $themeum_options['preloader_color'];
} else {
    $user = '#4bb463';
}
$pre_bg = '';
if ( $themeum_options['preloader_color'] ) {
   $pre_bg = $themeum_options['preloader_bg_color'];
} else {
    $pre_bg = '#fff';
}

?>
<input type="hidden" id="hidden_id" value="<?php echo $user; ?>">
<input type="hidden" id="hidden_pre" value="<?php echo $pre_bg; ?>">
