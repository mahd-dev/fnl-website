...
if(isset($themeum_options['custom-preset-en']) && $themeum_options['custom-preset-en']) {
	...
	if(isset($link_color)){
		...
		.woocommerce .woocommerce-message,.woocommerce-page .woocommerce-message,.wpcf7-form-control.wpcf7-submit { background-color: '. esc_attr($link_color) .'; }';
		...
		.Gym-Button-Light:hover a.btn-white,.tp-caption.Gym-Button-Light:hover a.btn-white,#navigation .woocommerce ul.cart_list li a,#main-menu .nav>li>a:hover,#main-menu .nav>li>a:hover,ul.latest-review h3.entry-title a:hover,#main-menu .nav>li.active.current>a{ color: '. esc_attr($link_color) .'; }';
...
if(isset($themeum_options['custom-preset-en']) && $themeum_options['custom-preset-en']) {
	...
	if(isset($themeum_options['hover-color'])){
		...
		.woocommerce a.button:hover,.woocommerce input.button:hover,.wpcf7-form-control.wpcf7-submit:hover{ background: '.esc_attr($themeum_options['hover-color']) .'; }';
	}
}
