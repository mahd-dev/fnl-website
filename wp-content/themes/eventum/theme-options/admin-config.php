            ...
            ***********************************/
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'subheader-title-bg',
                        'type'      => 'switch',
                        'title'     => __('Title Background', 'eventum'),
                        'subtitle' => __('Enable or disable Title Background', 'eventum'),
                        'default'   => true,
                    ),
                    ...
                    array(
                        'id'        => 'subheader-bg',
                        'type'      => 'color',
                        'title'     => __('Sub Header Background Color', 'eventum'),
                        'subtitle'  => __('Pick a background color for the Sub header (default: #fff).', 'eventum'),
                        'default'   => '#fff',
                        'validate'  => 'color',
                        'transparent'   =>false,
                    ),
